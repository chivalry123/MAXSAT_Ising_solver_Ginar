...
//                   bool obscenely_verbose);
        ...
        global_parameters.dedicated1D=true;
        bool obscenely_verbose=false;
        bool verbose=false;
        bool very_verbose=false;
        global_parameters.model_numbers=40;
        ...
        run_solver(max_sites, H, lowerboundclustertype, upperboundclustertype, cellrepresentation,
                   ...
                   exact_mode, pseudo_mode, proof_mode, verbose, very_verbose, obscenely_verbose,input_PRIM_output_PRIMOUT_mode,limit_dimension,constant);
