...
int main(int argc, char **argv)
{
	...
	my_result_file = "ccls_res_" + my_pid_str + "_" + my_time_str+"_from_"+my_instance;
	my_command = "./CCLS2014_LB " + my_instance + " 1 10 > ./" + my_result_file;
	...
	my_command = "./akmaxsat_LB " + my_instance + " ./" + my_result_file + " " + terminating_gap_str;
	cout<<"c "<<my_command<<endl;
